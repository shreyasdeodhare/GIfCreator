...
class GIFmaker(tk.Tk): 
    def __init__(self):
        ...
        self.canvas = tk.Canvas(self, width=700, height=300, background="#808080")
    ...
    def select_video(self): 
        self.video_path = filedialog.askopenfilename(title='Select Video', file=(("Mp4 Files", "*.mp4"), ("All Files", "*.*")))
        if self.video_path:
            self.process_video()
    ...
    def animate_preview(self): 
        ...
        frame_image = frame_image.resize((640, 480), Image.LANCZOS)
        ...
        self.after(600, self.animate_preview)
